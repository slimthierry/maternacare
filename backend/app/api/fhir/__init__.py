...
from app.api.fhir.patient import router as patient_router
from app.api.fhir.condition import router as condition_router
from app.api.fhir.observation import router as observation_router
from app.api.fhir.encounter import router as encounter_router
